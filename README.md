...
| Integrante                        | Função                         |
| --------------------------------- | ------------------------------ |
| Arthur Passareli Moretti          | Banco de Dados                 |
| João Vitor da Silva Costa         | Dev Back-end                   |
| Luiz Antônio Martins Garcia Filho | Dev Front-end                  |
| Thaís Vitória Dias Rosa           | Líder Técnico / UX/UI Designer |
